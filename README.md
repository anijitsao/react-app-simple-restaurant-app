...
<ul>
 <li> Searching facility using <code>locality, name</code> and <code>cuisines</code are supported </li>
 <li> Searching can be done from <i>two</i> places - the <i>Search box</i> and clicking on the several features of a restaurant like    <i>name, locality</i> and so on </li>
